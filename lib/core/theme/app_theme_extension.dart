...
class AppThemeExtension extends ThemeExtension<AppThemeExtension> {
  ...
  static const AppThemeExtension dark = AppThemeExtension(
    cellBackground: Color(0xFF1A1A1A),
    ...
    eraseButtonBackground: Color(0xFF141414),
